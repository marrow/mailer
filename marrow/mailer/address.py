...
class AddressList(list):
    ...
    def string_addresses(self, encoding=None):
        ...
        encoding = encoding if encoding else self.encoding
        return [native(a, encoding=encoding) for a in [
            i.address for i in self]]
        # TODO The above line needs to be validated.
        # The previous version does not work on Python 3:
