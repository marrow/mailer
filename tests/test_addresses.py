...
class TestAddressList(object):
    ...
    def test_bytes(self):
        self.addresses = [('User1', 'foo@exámple.test'),
                          ('User2', 'foo@exámple.test')]
        eq_(bytes(self.addresses),
    ...
    def test_addresses(self):
        self.addresses = [('Test User 1', 'user1@example.com'),
                          ('Test User 2', 'user2@example.com')]
        eq_(self.addresses.addresses,
            AddressList('user1@example.com, user2@example.com'))
    ...
    def test_validation_strips_multiline_addresses(self):
        ...
        eq_(['user.name+test@info.example.com', evil_lines[0]],
                         self.addresses)
